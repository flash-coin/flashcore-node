...
A Flashcoin full node for building applications and services with Node.js. A node is extensible and can be configured to run additional services. At the minimum a node has an interface to [Litecoin Core with additional indexing](https://github.com/litecoin-project/litecore-litecoin) for more advanced address queries. Additional services can be enabled to make a node more useful such as exposing new APIs, running a block explorer and wallet service.
...
Flashcore includes a Command Line Interface (CLI) for managing, configuring and interfacing with your Litecore Node.

```bash
flashcore-node create -d <bitcoin-data-dir> mynode
cd mynode
flashcore-node install <service>
flashcore-node install https://github.com/yourname/helloworld
```
...
Code released under [the MIT license](https://github.com/flashcoin-project/flashcore-node/blob/master/LICENSE).

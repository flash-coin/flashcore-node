...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `flashcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ flashcore-node add wallet-service');
      console.log('    $ flashcore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ flashcore-node remove wallet-service');
      console.log('    $ flashcore-node remove insight-api');
      console.log();
    });

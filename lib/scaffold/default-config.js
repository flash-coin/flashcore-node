...
/**
 * Will return the path and default flashcore-node configuration. It will search for the
 * configuration file in the "~/.flashcoin" directory, and if it doesn't exist, it will create one
...
function getDefaultConfig(options) {
  ...
  var defaultPath = path.resolve(process.env.HOME, './.flashcoin');
  var defaultConfigFile = path.resolve(defaultPath, './flashcore-node.json');
